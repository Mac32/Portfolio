export default function SectionDescriptionHero (): JSX.Element {
  return (
    <div id='aboutMe' className='mt-6 pt-6 lg:ml-3 lg:rounded-l-full lg:px-6 pb-6 flex flex-col justify-around lg:w-5/6 items-center z-10 bg-[#021F59]/70'>
      <div>
        <p className='italic m-3 lg:ml-48 border border-transparent border-r-white border-b-white md:text-xl inline-block pr-2'>DESARROLLADOR WEB</p>
      </div>
      ...
      <div className='my-9 lg:ml-40 '>
        <a className='border hover:border-[#2B1C8C] transition-all ease-in-out hover:animate-pulse bg-[#021F59]/80 border-white rounded-full px-4 py-9' href='#contactMe'><hr className='w-32 -rotate-45 border-t-white -z-10 absolute mt-3' />Hablemos</a>
      </div>
    </div>
  )
}
